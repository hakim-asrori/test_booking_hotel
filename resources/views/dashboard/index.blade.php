                                ...
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama</th>
                                            <th>Kamar</th>
                                            <th class="text-center">Menempati</th>
                                            <th>Sisa hari</th>
                                            <th>Kekurangan</th>
                                    ...
                                    <tbody>
                                        @forelse ($transactions as $transaction)
                                            <tr>
                                                ...
                                                <td>{{ Helper::getDateDifference(now(), $transaction->check_out) == 0 ? 'Hari Terakhir' :  Helper::getDateDifference(now(), $transaction->check_out). ' '. Helper::plural('Day', Helper::getDateDifference(now(), $transaction->check_out))}}
                                                </td>
                                                <td>
                        ...
                        <div class="card shadow-sm border">
                            <div class="card-header border-0">
                                <div class="d-flex justify-content-between">
                                    <h3 class="card-title">Data Tamu/Bulan</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
